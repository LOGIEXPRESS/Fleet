...
const SimpleModalcapacity = (props) => {
  const navigation = useNavigation();

  let closeModal = (bool, data) => {
    props.changeModalVisible17(bool);
    props.setData17(data);
  };
      ...
      <View style={styles.modal}>
        <View style={styles.textView}>
          ...
          <Text style={{ fontSize: 16, margin: 7 }}>
            ¡Ingresa la Capacidad correctamente!
          </Text>
        </View>
...
export default SimpleModalcapacity;
