...
const SimpleModallog2 = (props) => {
  const navigation = useNavigation();

  let closeModal = (bool, data) => {
    props.changeModalVisible400(bool);
    props.setData400(data);
  };
    ...
    <TouchableOpacity disabled={true} style={styles.container}>
      <View style={styles.modal}>
        <View style={styles.textView}>
          ...
          ¡La dirección de correo electrónico o el color no son válidas!
          </Text>
        </View>
...
export default SimpleModallog2;
